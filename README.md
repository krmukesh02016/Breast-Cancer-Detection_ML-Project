...
The Projects Features Detection of Breast Cancer Using Machine Learning. It has been tested that while there exists several machine learning models,Suppor vector Classifierin,Logistic Regression ,K – Nearest Neighbor Classifier ,Naive Bayes Classifier , Decision Tree Classifier ,Random Forest Classifier ,XGBoost Classifier in short is reported to have highest accuracy of (approximately 98%) in detecting breast cancer.
